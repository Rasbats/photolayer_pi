 ...
 * Author:   Mike Rossiter based on WeatherFax by Sean D'Epagnier, based on imgkap.c by M'dJ
 *
 ***************************************************************************
...
int wximgtokap(PhotoLayerImage &image, int colors, int units, const char *sd, const char *fileout)
{
