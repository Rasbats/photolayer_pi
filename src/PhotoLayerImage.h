...
{
PhotoLayerImageCoordinates(wxString n) : name(n), 
        p1(wxPoint(0, 0)), p2(wxPoint(0, 0)), lat1(0), lon1(0), lat2(0), lon2(0), CenterLat(0), CenterLon(0),
...
WX_DECLARE_LIST(PhotoLayerImageCoordinates, PhotoLayerImageCoordinateList);

class PhotoLayerImage
{
public:
        PhotoLayerImage(wxImage img, int transparency, int whitetransparency, bool invert)
            : m_origimg(img),
    ...
    PhotoLayerImage(PhotoLayerImage &img)
    {
        *this = img;
        m_CacheBitmap = NULL;
        m_gltextures = NULL;
    ...
    wxImage m_mappedimg;
    PhotoLayerImageCoordinates *m_Coords;
