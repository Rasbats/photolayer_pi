...
#ifndef _PHOTOLAYERPI_H_
#define _PHOTOLAYERPI_H_
...
#define     MY_PLUGIN_VERSION_MINOR    1.2
...
#define PHOTOLAYER_TOOL_POSITION    -1          // Request default positioning of toolbar tool
...
//    The required PlugIn Methods
	  ...
	  void SetPhotoLayerDialogWidth(int x){ m_display_width = x; };
	  void SetPhotoLayerDialogHeight(int x){ m_display_height = x; };
...
//    Other public methods
      ...
      PhotoLayer      *m_pPhotoLayer;

private:
      void ReadImageToRender(PhotoLayerImage *image);
